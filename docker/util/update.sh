...
cp -f $FRIDAY_HOME/movies-all/target/movies-all-*-exec.jar $FRIDAY_HOME/docker/movies-fe/movies.jar
cp -f $FRIDAY_HOME/docker/movies/Dockerfile $FRIDAY_HOME/docker/movies-fe/Dockerfile
cp -f $FRIDAY_HOME/docker/movies/application.yml $FRIDAY_HOME/docker/movies-fe/application.yml
